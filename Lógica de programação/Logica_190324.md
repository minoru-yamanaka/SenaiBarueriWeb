...
- **Início ou Fim:** Um retângulo com bordas arredondadas, indicando o início ou fim de um processo.
   
- **Processamento:** Um retângulo normal indicando uma etapa de processamento.
   
- **Entrada de Dados Manual:** Um paralelogramo indicando entrada manual de dados.
   
- **Exibe Informações:** Um losango indicando a exibição de informações.

Aqui está o desenho correspondente:

    ┌──────────┐    ┌────────┐    ┌───────┐    ┌─────┐
    │Início/Fim│--->│Processo│--->│Entrada│--->│Exibe│
    └──────────┘    └────────┘    └───────┘    └─────┘


### Exercícios
- [diagrama_de_blocos_media](diagrama_de_blocos_media.pdf)
- [diagrama_de_blocos_soma](diagrama_de_blocos_soma.pdf)
...
exercício
- [diagrama_de_blocos_reprovado](diagrama_de_blocos_reprovado.pdf)